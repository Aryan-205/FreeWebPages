...
export default function BloomAILanding() {
  return (
    <div className={`${figtree.className} min-h-screen bg-[#FDF6F9] text-[#111111] selection:bg-[#F8B4C6] selection:text-white`}>
      <style jsx global>{`
        body {
        ...
        <div className="w-full max-w-7xl pl-8 pr-2 py-2 flex items-center justify-between bg-white/20 backdrop-blur-sm rounded-full border border-white/20 shadow-sm">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium text-[#555555]">
            {["Features", "How It Works", "Pricing", "Testimonials"].map((item) => (
              <a key={item} href="#" className="hover:text-[#EC407A] text-lg font-medium transition-colors">{item}</a>
            ))}
          </div>
      ...
      <main className="relative z-10 pt-40 pb-20 px-6">
        ...
        <section className="max-w-[900px] mx-auto text-center flex flex-col items-center gap-8">
          ...
          >
            Think Clearly.<br />Build Fearlessly.
          </motion.h1>
          ...
          >
            BloomAI transforms your scattered thoughts into structured action plans. 
            Journal with AI, organize your ideas, and move forward with clarity.
          </motion.p>
        ...
        <section className="max-w-4xl mx-auto mt-40 text-center">
           ...
           <p className="mt-6 text-[#555555] uppercase tracking-widest text-sm">— Founder, YC-backed startup</p>
        </section>

        {/* --- FINAL CTA --- */}
        <section className="mt-40 mb-20 text-center">
          <h2 className="text-4xl font-bold mb-8">Start thinking with clarity today.</h2>
